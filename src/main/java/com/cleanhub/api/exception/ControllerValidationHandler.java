...
import com.cleanhub.api.dto.ErrorDTO;
import com.cleanhub.api.dto.MessageType;
...
public class ControllerValidationHandler {
	...
	@ExceptionHandler(value = CleanhubMessageException.class)
	protected ResponseEntity<ErrorDTO> handleConflict(CleanhubMessageException exception, WebRequest request) {
